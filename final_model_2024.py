...
for (abbr, teamId) in abbrs_Ids:
    schedule_url = f'https://site.api.espn.com/apis/site/v2/sports/football/college-football/teams/{teamId}/schedule?season=2025'
...
print("Simulating season 100,000 times...")
...
bowl_list_b1g = ['Orlando', 'Tampa', 'Las Vegas', 'Nashville', 'New York', 'Phoenix', 'Detroit', 'Other']
Minn_bowl_per_sim = []
...
while n < 100000:
    ...
    if temp_wins == 5:
        if fiveand7_bowl == True: 
            ...
            Minn_bowl_per_sim.append(bowl_list_b1g[min(7,b1g_all - 3)])
        else:
        ...
        bowl_index = min(7, b1g_win_dict[temp_wins] - (playoff_counter + 1) + below_bowl)
...
print("Detroit odds: ", MN_bowl_locs['Detroit'] / total_simulations)
